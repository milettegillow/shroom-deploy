...
export default function Mushroom() {
  ...
  useFrame(({ clock }, delta) => {
    ...
    const { evolution, hunger, boredom, lastFeedTime } = useMushroomStore.getState()
    ...
    groupRef.current.rotation.z = Math.sin(t * swayAnim.swaySpeed) * swayAnim.swayAmt + talkWobble.current * Math.sin(t * 12) * 0.08
